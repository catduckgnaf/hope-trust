      ...
      for (let i = 0; i < partners.length; i++) {
        ...
        for (let i = 0; i < memberships.length; i++) {
          ...
          the_account.clients.push({
            ...
            plan: account_plan ? account_plan.name : "None",
