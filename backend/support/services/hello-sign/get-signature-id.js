...
const getHelloSignSignatureId = async (subject, message, signers, templates, partner, user, cost, full_cost, additional_plan_credits, additional_plan_cost) => {
  const options = {
    ...
    message,
    signers,
    custom_fields: setCustomFields(templates, signers, partner, user, cost, full_cost, additional_plan_credits, additional_plan_cost)
  };
