import { BULK_UPDATE_CLIENT_REGISTRATION, UPDATE_CLIENT_REGISTRATION, CLEAR_CLIENT_REGISTRATION, CLEAR_ALL, IS_LOGGED_OUT } from "../actions/constants";
...
const clientRegistration = (state = defaultState, { type, payload }) => {
  switch (type) {
    ...
    case CLEAR_CLIENT_REGISTRATION:
      return { ...defaultState, preserved_details: state.preserved_details };
    case CLEAR_ALL:
      return defaultState;
    case IS_LOGGED_OUT:
      return defaultState;
