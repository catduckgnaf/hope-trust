...
class StripePaymentForm extends Component {
  ...
  render() {
    ...
    const { setNewState, details, termsAccepted, SAASAccepted, missingFields, is_partner_creation } = this.props;
      ...
      <StripePaymentMain>
        <StripePaymentSections gutter={25}>
          ...
          <StripePaymentSection xs={12} sm={7} md={5} lg={5} xl={5}>
            ...
            <TermsOfServiceCheck margintop={20} title="Software as a Service Agreement" setNewState={setNewState} accepted={SAASAccepted} url="https://www.hopetrust.com/saas-agreement/" id="SAAS_accepted" />
            <TermsOfServiceCheck margintop={10} title="Terms of Service" setNewState={setNewState} accepted={termsAccepted} url="https://www.hopetrust.com/terms-of-service/" id="terms_accepted" />
          </StripePaymentSection>
        </StripePaymentSections>
      </StripePaymentMain>
    );
