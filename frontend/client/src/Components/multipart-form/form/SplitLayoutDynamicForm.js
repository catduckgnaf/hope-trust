...
import * as Split from "../layouts/split-layout.styles";
...
export const SplitLayoutDynamicForm = (props) => {
  ...
  return (
    <Split.MultipartFormForm>
      <Split.FormInputsContainer>
      ...
      <Split.FormActions>
        ...
        {slides[current_slide].containerLink
          ? slides[current_slide].containerLink(formState.stateRetriever, formState.helpers)
          : null
        }
      </Split.FormActions>
    </Split.MultipartFormForm>
