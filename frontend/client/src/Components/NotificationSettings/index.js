  ...
  render() {
    ...
    return (
      <RowBody>
        ...
        <RowContentSection span={12}>
          <SaveNotificationSettingsButton onClick={() => this.saveNotificationSettings()} green>{is_loading ? <FontAwesomeIcon icon={["far", "spinner"]} spin /> : "Save Notification Preferences"}</SaveNotificationSettingsButton>
        </RowContentSection>
      </RowBody>
    );
  }
