...
const config = {
  ...
  sidebar: (stateRetriever) => (
    <>
      <SidebarSubheading>For your account security, we must verify that you own your email address.</SidebarSubheading>
      <SidebarDivider />
      <SidebarHeading>
        <Semibold>A verification code has been sent to <Bold>{stateRetriever("email")}</Bold>, please enter this code and click <Bold>Verify</Bold></Semibold>
      </SidebarHeading>
    </>
  ),
  ...
  lifecycle: {
    ...
    onSubmit: async (stateRetriever, stateConsumer, helpers) => await helpers.runVerification(stateRetriever("verification_code")),
