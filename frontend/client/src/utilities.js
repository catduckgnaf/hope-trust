...
export const isValidURL = (url) => {
  const patt = new RegExp(/[(http(s)?):(www.)?a-zA-Z0-9@:%._~#=]{2,256}.[a-z]{2,6}\b([-a-zA-Z0-9@:%_.~#?&=]*)/ig);
...
export const buildHubspotPartnerCreatedDealData = (object_data, user) => {
  ...
  return {
    associations: {
      associatedVids: [user.hubspot_contact_id, object_data.hubspot_contact_id],
