...
export const step_conditions = (state) => {
  return {
    "About You": [
      ...
      () => state.creatorDetails.email.includes("@hopetrust.com"),
      () => (state.creatorDetails.password && state.creatorDetails.confirmPassword) && checkPasswordConditions(16, state.creatorDetails.password, state.creatorDetails.confirmPassword).pass,
