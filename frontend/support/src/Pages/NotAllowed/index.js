      ...
      <NotAllowedMain>
        <NotAllowedPadding>
          <NotAllowedInner gutter={20}>
            ...
            <NotAllowedInnerSection span={12}>
              {user
                ? <Button nomargin outline green onClick={user.is_partner ? () => navigateTo("/accounts") : () => navigateTo("/")}>Go Back</Button>
                : <Button nomargin outline green onClick={() => history.goBack()}>Go Back</Button>
              }
