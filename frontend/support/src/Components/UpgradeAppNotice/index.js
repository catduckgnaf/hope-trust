...
class UpgradeAppNotice extends Component {
  ...
  constructor(props) {
    ...
    this.state = {
      show: true,
      do_not_show_routes: ["/client-registration", "/partner-registration"]
    };
  }
        ...
        <UpgradeAppNoticePadding>
          <UpgradeAppNoticeInner>
            ...
            <UpgradeAppNoticeInnerSection span={12}>
              <UpgradeAppSectionHeader>New Release!{customer_support.core_settings.incoming_support_app_version ? ` (v${customer_support.core_settings.incoming_support_app_version})` : null}</UpgradeAppSectionHeader>
            </UpgradeAppNoticeInnerSection>
            <UpgradeAppNoticeInnerSection span={12}>
              <UpgradeAppSectionMessage>
