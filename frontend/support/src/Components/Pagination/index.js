      ...
      <PaginationMain>
        <PaginationContainer padding={padding}>
          ...
          <PaginationSection xs={12} sm={12} md={6} lg={6} xl={6} align="right">
            {page > 1
              ? <Button nomargin outline blue onClick={() => paginate(previous_page)}>Previous Page</Button>
              : null
            }
            {(page < total_pages) && items.length
              ? <Button nomargin marginleft={10} outline blue onClick={() => paginate(next_page)}>Next Page</Button>
              : <Button disabled nomargin marginleft={10} outline blue>Next Page</Button>
            }
          </PaginationSection>
        </PaginationContainer>
      </PaginationMain>
