...
class ForgotPasswordConfirmation extends Component {
  ...
  render() {
    ...
    const passwordCheck = checkPasswordConditions(16, password, confirm_password);
        ...
        <ForgotPasswordConfirmationFormMain>
          ...
          <ForgotPasswordConfirmationFormFields>
            ...
            <InputWrapper>
              ...
              <PasswordStrengthBar password={password} scoreWords={["very weak", "weak", "okay", "good", "strong"]} shortScoreWord="Password too short" minLength={16} />
            </InputWrapper>
            <InputWrapper>
