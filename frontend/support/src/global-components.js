...
export const Text = styled.span`
  ...
  `};
  ${(props) => props.priority === "normal" && css`
    color: ${lighten(0.1, theme.neutral_blue)};
  `};
  ${(props) => props.priority === "high" && css`
    color: ${lighten(0.1, theme.errorRed)};
  `};
...
export const Icon = styled.div`
  ...
  ${(props) => props.type === "domain_approval" && css`
    color: ${theme.purple};
  `};
  ${(props) => props.type === "course_passed" && css`
    color: ${theme.black};
  `};
