...
export const ViewBenefitsModuleModalInnerLogoOverlay = styled.div`
  width: 100px;
  height: 100px;
  border-radius: 50%;
  position: absolute;
...
export const ViewBenefitsModuleModalInnerLogoContainer = styled.div`
  width: 100px;
  border-radius: 50%;
  position: relative;
  margin: auto;
...
export const ViewBenefitsModuleModalInnerLogoOverlayIcon = styled.div`
  position: absolute;
  margin: auto;
  top: 0;
  bottom: 0;
