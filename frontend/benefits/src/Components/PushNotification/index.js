                              ...
                              ? (
                                  <PushSection span={12}>
                                    <PushActions gutter={20}>
                                      <PushSection span={6}>
                                      {is_in_app_link
                                        ? <Button widthPercent={100} nohover nomargin outline rounded small danger={button_type === "danger" ? 1 : 0} green={button_type === "green" ? 1 : 0} warning={button_type === "warning" ? 1 : 0} onClick={() => {
                                      ...
                                      {is_function
                                        ? <Button onClick={() => this.runFunction(notification.key, notification.href)} widthPercent={100} nohover nomargin outline rounded small danger={button_type === "danger" ? 1 : 0} green={button_type === "green" ? 1 : 0} warning={button_type === "warning" ? 1 : 0}>{notification.href_text}</Button>
                                        : null
                                      }
                                      </PushSection>
                                      <PushSection span={(is_external_link || is_in_app_link || is_function) ? 6 : 12}>
                                        <Button widthPercent={100} nohover nomargin outline rounded small danger={button_type === "danger" ? 1 : 0} green={button_type === "green" ? 1 : 0} warning={button_type === "warning" ? 1 : 0} onClick={() => this.view(notification.key)}>Close</Button>
                                      </PushSection>
                                    </PushActions>
                                  </PushSection>
                              )
