...
class BeneficiarySignUpForm extends Component {
  ...
  render() {
    let { details, setNewState, missingFields, client_email_error, client_email_valid, is_checking_client_email } = this.props;
            ...
            <Col xs={12} sm={12} md={12} lg={12} xl={12}>
              ...
              <Row>
                {!details.noBeneficiaryEmail
                  ? (
                    <Col xs={12} sm={12} md={details.creation_type === "invite" ? 12 : 6} lg={details.creation_type === "invite" ? 12 : 6} xl={details.creation_type === "invite" ? 12 : 6}>
                      <InputWrapper>
                        <InputLabel>{details.creation_type === "invite" ? <RequiredStar>*</RequiredStar> : null} Email</InputLabel>
                        <Input
                          autoComplete="new-password"
                          autofill="off"
                          type="text"
                ...
                {details.beneficiaryEmail && details.creation_type !== "invite"
                  ? (
                    <Col xs={12} sm={12} md={6} lg={6} xl={6}>
                      <InputWrapper>
