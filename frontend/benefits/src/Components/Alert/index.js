...
class Alert extends Component {
  ...
  render() {
    const { config, body, runCustomAction, hideBannerNotification, path } = this.props;
                ...
                ? (
                  <AlertActionContainer>
                    <Button
                      ...
                      onClick={() => runCustomAction(action, body)}>
                      {button_text}
                    </Button>
                    {!hide_close
                      ? (
...
const dispatchToProps = (dispatch) => ({
  runCustomAction: (action, body) => dispatch(runCustomAction(action, body)),
