...
class UpgradeAppNotice extends Component {
  ...
  constructor(props) {
    ...
    this.state = {
      show: true,
      do_not_show_routes: ["/registration", "/accounts", "/account-registration"]
    };
  }
        ...
        <UpgradeAppNoticePadding>
          <UpgradeAppNoticeInner>
            ...
            <UpgradeAppNoticeInnerSection span={12}>
              <UpgradeAppSectionHeader>New Release!{customer_support.core_settings.incoming_benefits_app_version ? ` (v${customer_support.core_settings.incoming_benefits_app_version})` : null}</UpgradeAppSectionHeader>
            </UpgradeAppNoticeInnerSection>
            <UpgradeAppNoticeInnerSection span={12}>
              <UpgradeAppSectionMessage>
            ...
            <UpgradeAppNoticeInnerSection span={12}>
              <UpgradeAppSectionButtonContainer>
                <Button widthPercent={80} outline blue rounded onClick={() => this.updateAppVersion()}>Update</Button>
              </UpgradeAppSectionButtonContainer>
            </UpgradeAppNoticeInnerSection>
          </UpgradeAppNoticeInner>
        </UpgradeAppNoticePadding>
